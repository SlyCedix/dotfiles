...
function __promptline {
  ...
  local b_bg="${wrap}48;5;18${end_wrap}"
  local b_sep_fg="${wrap}38;5;18${end_wrap}"
  ...
  local y_fg="${wrap}38;5;20${end_wrap}"
  local y_bg="${wrap}48;5;18${end_wrap}"
  local y_sep_fg="${wrap}38;5;18${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
